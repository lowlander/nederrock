...
#ifndef NEDERROCK_SRC_CEIL_PARSER_NODE_HPP
#define NEDERROCK_SRC_CEIL_PARSER_NODE_HPP
...
public:
  Ceil_Parser_Node(Choice_1&& choice);
  Ceil_Parser_Node(Choice_2&& choice);

  static Ceil_Parser_Node_Ptr parse_choice_1(Token_Stream& input);
  static Ceil_Parser_Node_Ptr parse_choice_2(Token_Stream& input);

  static Ceil_Parser_Node_Ptr parse(Token_Stream& input);
...
#endif // NEDERROCK_SRC_CEIL_PARSER_NODE_HPP
