...
#ifndef NEDERROCK_SRC_DIVIDE_PARSER_NODE_HPP
#define NEDERROCK_SRC_DIVIDE_PARSER_NODE_HPP
...
class Divide_Parser_Node {
public:
  Divide_Parser_Node(Separator_Parser_Node_Vector&& separators_1,
                     std::wstring&& keyword,
                     Separator_Parser_Node_Vector&& separators_2);

  static Divide_Parser_Node_Ptr parse(Token_Stream& input);
...
#endif // NEDERROCK_SRC_DIVIDE_PARSER_NODE_HPP
