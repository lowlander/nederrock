...
#ifndef NEDERROCK_SRC_FLOOR_PARSER_NODE_HPP
#define NEDERROCK_SRC_FLOOR_PARSER_NODE_HPP
...
public:
  Floor_Parser_Node(Choice_1&& choice);
  Floor_Parser_Node(Choice_2&& choice);

  static Floor_Parser_Node_Ptr parse_choice_1(Token_Stream& input);
  static Floor_Parser_Node_Ptr parse_choice_2(Token_Stream& input);

  static Floor_Parser_Node_Ptr parse(Token_Stream& input);
...
#endif // NEDERROCK_SRC_FLOOR_PARSER_NODE_HPP
