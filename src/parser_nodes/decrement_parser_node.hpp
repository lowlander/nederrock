...
#ifndef NEDERROCK_SRC_DECREMENT_PARSER_NODE_HPP
#define NEDERROCK_SRC_DECREMENT_PARSER_NODE_HPP
...
public:
  Decrement_Parser_Node(std::wstring&& keyword,
  ...
  static Decrement_Parser_Node_Ptr parse(Token_Stream& input);
...
#endif // NEDERROCK_SRC_DECREMENT_PARSER_NODE_HPP
