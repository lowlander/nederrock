...
void Poetic_Decimal_Digits_Parser_Node::Choice_1::dump(std::wostream& output) const
{
...
void Poetic_Decimal_Digits_Parser_Node::Choice_2::dump(std::wostream& output) const
{
  m_poetic_digit->dump(output);
}

Poetic_Decimal_Digits_Parser_Node::Poetic_Decimal_Digits_Parser_Node(Choice_1&& choice)
  : m_choice(std::move(choice))
{
}

Poetic_Decimal_Digits_Parser_Node::Poetic_Decimal_Digits_Parser_Node(Choice_2&& choice)
  : m_choice(std::move(choice))
{
}

Poetic_Decimal_Digits_Parser_Node_Ptr
Poetic_Decimal_Digits_Parser_Node::parse_choice_1(Token_Stream& input)
{
  ...
  choice.m_poetic_decimal_digit_separators_2 =
    parse_zero_or_more<Poetic_Decimal_Digit_Separator_Parser_Node>(input);
  if (choice.m_poetic_decimal_digit_separators_2.empty()) {
    input.seekg(offset);
    return nullptr;
  }
  ...
  return std::make_shared<Poetic_Decimal_Digits_Parser_Node>(std::move(choice));
}

Poetic_Decimal_Digits_Parser_Node_Ptr
Poetic_Decimal_Digits_Parser_Node::parse_choice_2(Token_Stream& input)
{
  auto offset = input.tellg();
...
Poetic_Decimal_Digits_Parser_Node_Ptr
Poetic_Decimal_Digits_Parser_Node::parse(Token_Stream& input)
{
  auto offset = input.tellg();
...
void Poetic_Decimal_Digits_Parser_Node::dump(std::wostream& output) const
{
  std::visit([&output](auto&& choice) { choice.dump(output); }, m_choice);
}

std::wstring Poetic_Decimal_Digits_Parser_Node::Choice_1::to_string() const
{
  std::wstring res;
...
std::wstring Poetic_Decimal_Digits_Parser_Node::Choice_2::to_string() const
{
  return m_poetic_digit->to_string();
}

std::wstring Poetic_Decimal_Digits_Parser_Node::to_string() const
{
